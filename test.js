...
test('append', function (t) {
  ...
  var l = new LT();
  var i = 100;
  var promise = l.append('lala', [[31,30],[40,40]]).then(function (a){
    return l.append('lala',[[32,40],[50,60]]);
  });
  var out = [];
  while (i--) {
      out.push(l.append('afa',[[20-i,20-i],[40-i,20+i]]));
  }
  promise.then(function () {
    return Promise.all(out);
  }).then(function (a) {
    ...
    t.equals(a.length, 102);
    return l.insert('lala', [[31,30],[40,40]]);
  }).then(function (a) {
    return l.query([ [ 31, 30 ], [ 50, 60 ] ], true);
  }).then(function(a){
    t.equals(a.length, 1);
